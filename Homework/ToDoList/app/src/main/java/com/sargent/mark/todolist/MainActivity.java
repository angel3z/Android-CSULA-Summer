...
// Added some code to Marks App
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Added the spinner to the main view
        spinner = (Spinner) findViewById(R.id.toDoSpinner);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        Spinner spin = (Spinner) view.findViewById(R.id.toDoSpinner);

        final String spin_text = spin.getSelectedItem().toString();
        String query = "SELECT * FROM todo WHERE category='" +  spin_text;
...
//        cv.put(Contract.TABLE_TODO.COLUMN_CATEGORY, category);
